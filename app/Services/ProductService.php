    ...
    public function updateOrCreate(array $data, ?Product $product = null): ?Product
    {
        try {
            ...
            $inputs = [
                ...
                'default_sold' => $data['default_sold'] ?? null,
                'show_default_sold' => $data['show_default_sold'] ?? 0,
                'total_delivery_day' => $data['total_delivery_day'] ?? null,
                'tags' => $data['tags'],
                ...
                'is_export' => $data['is_free_delivery'] ?? 0,
