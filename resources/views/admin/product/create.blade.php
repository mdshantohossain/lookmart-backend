                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control mb-1" id="default_sold"
                                       name="default_sold" value="{{ old('default_sold') }}"
                                ...
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="show_default_sold" name="show_default_sold" value="1"
                                        {{ old('show_default_sold') ? 'checked' : '' }}>
                                    <label for="show_default_sold" class="form-check-label">Show default sold</label>
                                </div>
                            </div>

                            <div class="col-md-4">
                                <label for="total_delivery_day" class="form-label">Total delivery day</label>
                                <input type="number" class="form-control" id="total_delivery_day"
                                       name="total_delivery_day" value="{{ old('total_delivery_day') }}"
