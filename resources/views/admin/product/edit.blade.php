                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                <label for="default_sold" class="form-label">Default Sold</label>
                                <input type="text" class="form-control  mb-1" id="default_sold"
                                       name="default_sold" value="{{ $product->default_sold }}"
                                       placeholder="Product default sold" />

                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="show_default_sold" name="show_default_sold" value="1"
                                        {{ old('show_default_sold', $product->show_default_sold) ? 'checked' : '' }}>
                                    <label for="show_default_sold" class="form-check-label">Show default sold</label>
                                </div>
                            </div>

                            <div class="col-md-4">
                                <label for="total_delivery_day" class="form-label">Total day for delivery</label>
                                <input type="text" class="form-control" id="total_delivery_day"
                                       name="total_delivery_day" value="{{ $product->total_delivery_day }}"
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="is_export" name="is_export" value="1"
                                    {{ old('is_export', $product->is_export) ? 'checked' : '' }}>
                                <label for="is_export" class="form-check-label">Is Export Product</label>
                            </div>
                        </div>
