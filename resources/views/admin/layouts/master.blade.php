            ...
            <div class="d-flex">
                ...
                @can('notification module')
                    ...
                    <button type="button" class="btn header-item noti-icon waves-effect" id="page-header-notifications-dropdown"
                        ...
                        <span class="badge bg-danger rounded-pill">{{ $notificationCount ?? 0 }}</span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                        ...
                        <div class="p-3">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto">
                                    <a href="{{ route('all.notifications') }}" class="small" key="t-view-all"> View All</a>
                                </div>
                            </div>
                        </div>
                        <div data-simplebar style="max-height: 230px;">
                            @forelse($notifications as $notification)
                                <a href="{{ route('orders.edit', $notification->data['slug']) }}" class="text-reset notification-item">
                                    <div class="d-flex">
                ...
                <div class="dropdown d-inline-block">
                    <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img class="rounded-circle header-profile-user" src="https://cdn.lookmartbd.com/assets/images/users/avatar-1.jpg"
                             alt="Header Avatar">
