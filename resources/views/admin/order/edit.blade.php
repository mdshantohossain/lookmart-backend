    ...
    <div class="container-fluid">
        ...
        <form action="{{ route('orders.update', $order->slug) }}" method="POST">
            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            <div class="row text-center border-bottom pb-3 mb-4">
                                <div class="col-md-4 border-end">
                                    ...
                                    <span class="fw-bold text-dark">{{ $order->payment_method == 1 ? 'Online' : 'Cash on Delivery' }}</span>
                                    <div class="small text-muted" style="font-size: 0.75rem;">{{ $order->bank_type ?? '' }}</div>
                                </div>
                                <div class="col-md-4 border-end">
                                ...
                                <div class="col-md-4">
                                    <small class="text-muted text-uppercase d-block mb-1 small fw-bold">Current Payment</small>
                                    <div class="mt-1">
                                        @if($order->payment)
                ...
                <div class="col-lg-4">
                    <div class="card border-0 shadow-sm mb-4 text-white" style="background-color: #2c3e50;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="pt-2 border-top border-secondary">
                                ...
                                <p class="mb-0 fw-bold text-info">{{ $order->phone }}</p>
                            </div>
                        </div>
                    </div>
