                    ...
                    <table id="datatable" class="table table-bordered dt-responsive nowrap w-100">
                        ...
                        @foreach($orders as $order)
                            <tr>
                                ...
                                <td>
                                    {{ $order->payment_type ? 'Online' : 'Cash On Delivery' }}
                                </td>
                                <td>
                                    {!! getStatus($order->payment_status, 'payment') !!}
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="d-flex gap-1">
                                        <a href="{{ route('orders.edit', $order->slug) }}" class="btn btn-outline-primary btn-sm"  data-bs-toggle="tooltip" title="Edit order">
